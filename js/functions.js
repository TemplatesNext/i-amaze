...
jQuery(document).ready(function($) {
	...
	*/
	...
	{			
		...
		// logo change on fullscreen slider
		//$( 'body' ).addClass( 'ibanner-on' );
...
(function($) {
	...
	if ( $('.ibanner').length > 0 )
	{
		...
		$('body').addClass('nx-fullscreen nx-transheader');
	}
	
	// transparent header
	if ( $('body.home').length > 0 )
	{
		$('body').addClass('nx-transheader');
	}	
